...
const App: () => React$Node = () => {
  ...
  const headGear = [
    ...
    },
    {
      name: 'Army Helmet',
      attributes: [
        {key: 'agility', value: '3/10'},
        {key: 'cost', value: '6/10'},
        {key: 'effectiveness', value: '9/10'},
      ],
      image:
  ...
  const weapons = [
    ...
    },
    {
      name: 'L1A1',
      attributes: [
        {key: 'agility', value: '4/10'},
        {key: 'cost', value: '6/10'},
        {key: 'effectiveness', value: '8/10'},
      ],
  ...
  const vests = [
    {
      name: 'M1951',
      attributes: [
        {key: 'agility', value: '7/10'},
        {key: 'cost', value: '6/10'},
        {key: 'effectiveness', value: '2/10'},
      ],
      image:
